...
select distinct(address), count(*) from tb_student group by address; --distinct 사용
...
문6)과목테이블에서 디자인 교과목중에서 3학점만 조회하시오x
select * from tb_gwamok;
...
-- 프로그램 교과목의 학점 평균보다 낮은 프로그램 교과목 조회
